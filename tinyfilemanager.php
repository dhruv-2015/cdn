...
$auth_users = array(
    ...
    'afhrjndofeouf' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZGO'//12345
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/dhruv-2015" target="_blank" class="app-v-title"> Dhruv's File Manager <?php echo VERSION; ?></a></h3></p>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = "Dhruv's File Manager";      $tr['en']['AppTitle']           = 'File Manager';
